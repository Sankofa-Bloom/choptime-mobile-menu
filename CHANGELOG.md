...
All notable changes to the ChopTym food delivery platform will be documented in this file.

## [2.0.0] - 2024-12-28

### 🎉 Major Backend Enhancement Release

This release transforms ChopTym from a basic MVP to a comprehensive food delivery platform with full backend management capabilities.
...
#### UI Components
- Modern design with ChopTym branding

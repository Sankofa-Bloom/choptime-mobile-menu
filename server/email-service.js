...
const sendEmail = async (to, subject, html, from = process.env.SMTP_USER || 'noreply@choptym.com') => {
  try {
      ...
      <div style="max-width: 600px; margin: 0 auto; background-color: #ffffff; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">
        ...
        <div style="background: #2c3e50; color: white; padding: 30px; text-align: center;">
          <div style="margin-bottom: 20px;">
            <h3 style="margin: 0; font-size: 20px; color: #D57A1F;">ChopTym</h3>
          ...
          <div style="display: flex; justify-content: center; gap: 20px; margin-bottom: 20px;">
            ...
            <a href="mailto:${process.env.ADMIN_EMAIL || 'admin@choptym.com'}" style="color: #D57A1F; text-decoration: none; font-size: 14px;">✉️ ${process.env.ADMIN_EMAIL || 'admin@choptym.com'}</a>
          </div>
...
const createAdminNotificationEmail = (orderData) => {
  return `
    ...
    <head>
      <meta charset="UTF-8">
      <meta name="viewport" content="width=device-width, initial-scale=1.0">
      <title>New Order - ChopTym Admin</title>
    </head>
    <body style="margin: 0; padding: 0; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; background-color: #f8f9fa;">
      <div style="max-width: 600px; margin: 0 auto; background-color: #ffffff; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">
        ...
        <div style="background: #2c3e50; color: white; padding: 30px; text-align: center;">
          <div style="margin-bottom: 20px;">
            <h3 style="margin: 0; font-size: 20px; color: #D57A1F;">ChopTym Admin</h3>
...
const createOrderStatusUpdateEmail = (orderData, status, message) => {
  ...
  return `
    ...
    <head>
      <meta charset="UTF-8">
      <meta name="viewport" content="width=device-width, initial-scale=1.0">
      <title>Order Update - ChopTym</title>
    </head>
    <body style="margin: 0; padding: 0; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; background-color: #f8f9fa;">
      <div style="max-width: 600px; margin: 0 auto; background-color: #ffffff; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">
